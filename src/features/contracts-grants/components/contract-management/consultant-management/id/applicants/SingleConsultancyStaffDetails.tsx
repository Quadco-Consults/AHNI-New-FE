            ...
            <div className="grid grid-cols-3 gap-10 mt-8">
                ...
                <section className="col-span-3 space-y-4">
                    <h3 className="font-bold text-xl text-gray-900 flex items-center gap-2 border-b pb-2">
                        <svg className="w-5 h-5 text-yellow-darker" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {effectiveInterviewScores && effectiveInterviewScores.total_score > 0 && (
                    <section className="col-span-3 space-y-4">
                        <h3 className="font-bold text-xl text-gray-900 flex items-center gap-2">
                            <svg className="w-6 h-6 text-yellow-darker" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <section className="col-span-3 space-y-4">
                        ...
                        {loadingInterviews ? (
                            <div className="text-center py-8">
                                <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-yellow-darker"></div>
