...
const AdminRFQ = () => {
  ...
  // Admin officers only handle Services RFQ
  const [activeTab] = useState<"SERVICES">("SERVICES");
  ...
  const { data, isLoading, isFetching } = useGetAllSolicitations({
    ...
    job_category: activeTab, // Only Services for Admin officers
  });
  ...
  return (
    <div className='space-y-10'>
      ...
      {/* Services RFQ Content - No tabs needed for Admin officers */}
