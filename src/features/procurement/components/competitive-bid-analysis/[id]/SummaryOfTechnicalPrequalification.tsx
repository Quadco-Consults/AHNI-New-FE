...
import VendorBidPrequalificationAPI from "@/features/procurement/controllers/manual-bid-cba-prequalification-fnController";
...
const SummaryOfTechnicalPrequalification = ({ id }) => {
  ...
  const { data: summaryData, isLoading } =
    VendorBidPrequalificationAPI.useGetVendorBidPrequalification({
      path: {
        // @ts-ignore
