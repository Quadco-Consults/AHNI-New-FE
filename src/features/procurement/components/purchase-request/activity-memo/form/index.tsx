...
const CreateActivityMemo = () => {
  ...
  // NOTE: Auto-population useEffect has been completely removed
  // It was clearing manual selections every time activity changed
  // Users now manually select all financial configuration fields
