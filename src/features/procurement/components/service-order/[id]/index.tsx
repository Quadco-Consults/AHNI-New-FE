            ...
            <div className='bg-gray-50 border border-gray-300 p-4 rounded'>
              ...
              <div className='space-y-3'>
                ...
                {data?.data?.purchase_request_detail && (
                  <div>
                    <p className='text-xs text-gray-600 uppercase font-semibold'>Purchase Request</p>
                    <p className='text-sm font-bold text-primary'>{data.data.purchase_request_detail.ref_number}</p>
                  </div>
                )}
