  ...
  return (
    <div className='py-6'>
      <h3 className='text-[20px] font-semibold mb-6 text-center'>
        STANDARD SERVICE ORDERS TERMS AND CONDITIONS
      </h3>
      <div className='flex justify-between gap-8'>
        <div className='flex-1 space-y-2'>
          <p className='text-[13px] leading-6'>
            These Standard Service Orders Terms and Conditions are particularly
            incorporated into, and are material terms and conditions for every
            Service Order entered into by and between Achieving Health Nigeria
            ...
            By signing a Service Order with AHNI, Vendor acknowledges that it
            has read, understood and agreed to these Terms and Conditions. Each
            Service Order issued by AHNI is subjected to these Terms and
            ...
            event of any inconsistency between these Service Order Terms and
            Conditions and the terms and conditions of any other agreement or
            document, the Service Order Terms and Conditions shall prevail and
          ...
          <p className='text-[13px] leading-6'>
            Nothing in the Terms and Conditions or the Service Order shall at
            ...
            the Service Order creates no relationship between Vendor and AHNI's
          ...
          <p className='text-[13px] leading-6'>
            ...
            this Service Order, unless Vendor obtains written permission from
          ...
          <h4 className='text-[14px] font-bold underline my-3'>
            5. SERVICE ORDERS ACCEPTANCE AND ACKNOWLEDGEMENT:
          </h4>
          <p className='text-[13px] leading-6'>
            The Service Order shall not become effective until these Service
            Order Terms and Conditions are signed by Vendor and authorized
            representatives of both parties have signed the Service Order.
          </p>
          ...
          <p className='text-[13px] leading-6'>
            ...
            Gross value of the Service Order except where it has been
          ...
          <ol>
            <li className='text-[13px] leading-6'>
              ...
              Service Order, to the extent practicable, at all places and
        ...
        <div className='flex-1  space-y-2'>
          ...
          <p className='text-[13px] leading-6'>
            ...
            Service Order or the award thereof. Vendor agrees that breach of
          ...
          <p className='text-[13px] leading-6'>
            ...
            Service Order, AHNI shall have the right to cancel the Service
          ...
          <ol>
            ...
            <li className='text-[13px] leading-6'>
              (b) This Service Order may be terminated upon default of either
              party in meeting its obligations hereunder.
            </li>
            <li className='text-[13px] leading-6'>
              (c) This Service Order may be terminated for convenience, without
              ...
              receive more than the original value of this Service Order.
            </li>
            ...
            <li className='text-[13px] leading-6'>
              ...
              Service Order. Vendor shall be given a reasonable opportunity to
            ...
            <li className='text-[13px] leading-6'>
              ...
              this Service Order by reason of any default, and AHNI further
              reserves the right to cancel this Service Order without further
          ...
          <p className='text-[13px] leading-6'>
            AHNI reserve the right to terminate this service order/subcontract
          ...
          <p className='text-[13px] leading-6'>
            ...
            timeframe as specified in the Service Order, AHNI shall require
            ...
            Service Order for each day of default. This liquidated damage
            ...
            listed delivery timeframe on the issued Service Order. If AHNI
            terminates this Service Order in part or whole as a result of
            default or failure to deliver or perform in part or whole as
            stipulated in the Service Order/Contract, Vendor is liable for
          ...
          <p className='text-[13px] leading-6'>
            ...
            condition of the Service Order. Liquidated damaged is adjudged fair
            ...
            an award of goods, services or works Service Orders and/or Contract
          ...
          <p className='text-[13px] leading-6'>
            Vendor certifies by acceptance of this Service Order that neither
      ...
      <div className='w-full flex justify-end my-8'>
        <Link href={RouteEnum.SERVICE_ORDERS} className=''>
          <Button>Service Order</Button>
        </Link>
      </div>
    </div>
  );
