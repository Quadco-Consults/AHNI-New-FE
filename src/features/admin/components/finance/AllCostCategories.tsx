...
export default function AllCostCategories() {
  ...
  const { data: costCategory, isFetching, refetch } = useGetAllCostCategoriesQuery({
    page,
    size: 20,
  });
  ...
  return (
    <div>
      <div className='flex items-center justify-between py-6 mb-6'>
        <h1 className='text-error font-semibold text-sm'>Categories</h1>
      ...
      <BulkUploadDialog
        ...
        apiEndpoint="/finance/cost-categories"
