          ...
          data && (
            <CardContent className='space-y-10'>
              <div className='grid grid-cols-1 gap-5 md:grid-cols-3'>
                ...
                <DescriptionCard label='Project Number' description='N/A' />
                ...
                <DescriptionCard
                  label='Phone Number'
                  description={data?.data.created_by.mobile_number}
                />
                ...
                <DescriptionCard label='City' description={data?.data.city} />
              ...
              <Form {...form}>
                ...
                >
                  ...
                  <div className='space-x-3'>
                    ...
                    <FormButton type='submit' className='bg-red-500' size='lg'>
                      Reject
                    </FormButton>
                  </div>
                </form>
