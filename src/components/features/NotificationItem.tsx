...
export default function NotificationItem({
    ...
    return (
        <li
            ...
            } border-gray-200 border-solid border-[1px] px-4 py-2 rounded-lg border-l-8 border-l-[#CB1A14] cursor-pointer hover:bg-gray-50`}
            onClick={() => onSetActiveNotification(notification)}
        >
            <div>
