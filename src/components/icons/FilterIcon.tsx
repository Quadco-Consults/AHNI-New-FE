...
const FilterIcon = ({size = '24'}: Props) => {
  return (
    ...
    <g opacity="0.4">
    <path fillRule="evenodd" clipRule="evenodd" d="M2 17C2 16.4477 2.44772 16 3 16H9C9.55228 16 10 16.4477 10 17C10 17.5523 9.55228 18 9 18H3C2.44772 18 2 17.5523 2 17Z" fill="#141B34"/>
    <path fillRule="evenodd" clipRule="evenodd" d="M14 7C14 6.44772 14.4477 6 15 6L21 6C21.5523 6 22 6.44772 22 7C22 7.55229 21.5523 8 21 8L15 8C14.4477 8 14 7.55228 14 7Z" fill="#141B34"/>
    </g>
    <path fillRule="evenodd" clipRule="evenodd" d="M2 7C2 6.44772 2.44772 6 3 6H6C6.55228 6 7 6.44772 7 7C7 7.55229 6.55228 8 6 8H3C2.44772 8 2 7.55229 2 7Z" fill="#141B34"/>
    <path fillRule="evenodd" clipRule="evenodd" d="M17 17C17 16.4477 17.4477 16 18 16H21C21.5523 16 22 16.4477 22 17C22 17.5523 21.5523 18 21 18H18C17.4477 18 17 17.5523 17 17Z" fill="#141B34"/>
