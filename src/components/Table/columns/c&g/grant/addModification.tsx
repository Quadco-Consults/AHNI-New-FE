...
} from "definations/c&g/modification";
import { useCreateModificationMutation } from "services/c&g/grant/grant";
...
const AddModification = () => {
  ...
  const [modification, { isLoading }] = useCreateModificationMutation();
