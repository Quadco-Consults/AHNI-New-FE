...
import { useGetOneAssetsRequestQuery } from "services/adminApi/assetsApi";
          ...
          <TabsContent value="details">
            <Card>
              ...
              <CardContent className="grid grid-cols-3 gap-y-8 gap-x-4">
                <AssetsItem heading="Asset" desc={data?.assets?.join(" ")} />
                ...
                <AssetsItem
                  ...
                  desc={data?.life_span_at_report as unknown as string}
                />
                ...
                <div className="col-span-3 ">
                  <AssetsItem heading="Remark" desc={data?.remark} />
                </div>
                {/* <Separator className="my-4" /> */}

                <div className="space-y-2">
                  <Button className="mt-2">GT CT Approval</Button>
                </div>
                <div className="space-y-2">
                  <Button className="mt-2">CCM Approval</Button>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
