...
const ManualSubGrantSubmission = () => {
    ...
    const [manualSubmissionMutation, manualSubmissionMutationResults] =
        SubGrantApplicationsApi.useAddSubGrantApplicationMutation();
    const onSubmit: SubmitHandler<
        z.infer<typeof ManualSubGrantSchemaOrgDetails>
    > = async (data) => {
        try {
            const result = await manualSubmissionMutation({
                ...data,
                sub_grant_id: params.id,
            ...
            <div className="w-full flex flex-col text-[#1A0000] px-5 gap-y-[3rem]">
                ...
                <Form {...form}>
                    <form
                        ...
                        className="flex flex-wrap w-full justify-between items-center gap-y-[1.25rem]"
                    >
                        ...
                        <div className="w-full flex flex-col gap-y-3">
                            <label htmlFor="" className="text-sm font-semibold">
                                Has Financial Conflict of Interest Policy as
                                applicable to U.S. PHS agencies’ funding.
                            </label>
                            <select
              ...
              /> */}
                        ...
                        <div className="flex w-full justify-end items-center gap-x-[1rem]">
                            ...
                            <div>
                                <FormButton
                                    loading={
                                        manualSubmissionMutationResults.isLoading
                                    }
                                >
                                    <p>Next</p>
                                </FormButton>
