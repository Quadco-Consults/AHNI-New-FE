    ...
    <div className="w-full bg-white px-[2.5rem] py-[1.25rem] rounded-2xl flex flex-col gap-y-[1.25rem]">
      ...
      <Card>
        <div className="w-full flex flex-col items-start justify-between p-3 gap-y-[1.25rem] text-[#1A0000]">
          ...
          <p>
            Malaria Control Program focused on delivering, monitoring, and
            evaluating interventions at the grassroots level, including: bed net
            distribution, case detection and treatment, operational research,
            and behaviour change communications, such as teaching people how to
            properly hang a net. <br />
            Wherever possible, the program sought to integrate malaria
            prevention activities with efforts to control or eliminate diseases
            such as lymphatic filariasis, river blindness, and trachoma,
            enabling village-based health care delivery systems to address
      ...
      <Card>
        ...
        <div className="grid grid-cols-2 gap-5 mt-5">
          ...
          <DescriptionCard label="Money Month Remaining" description="N/A" />
        </div>
      </Card>
    </div>
  );
