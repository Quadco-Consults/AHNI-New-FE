...
import { useGetSingleConsultancyReportQuery } from "services/c&g/contract-management/consultancy-report";

export default function ConsultancyReportDetails() {
    const { id } = useParams();

    const { data, isLoading } = useGetSingleConsultancyReportQuery(
        id ?? skipToken
    );
