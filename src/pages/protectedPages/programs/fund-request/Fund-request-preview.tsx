...
const Summary = () => {
  ...
  const projectQueryResult = projectsAPi.useGetProjectQuery({
    path: { id: projectFundRequest.project as string },
  });

  console.log(projectQueryResult.data?.title);
      ...
      <div className="space-y-5">
        ...
        <div className="grid pb-5 grid-cols-2 gap-5 md:grid-cols-3">
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-500">{projectFundRequest?.type}</p>
          </div>
          <div className="space-y-3">
