...
const columns: ColumnDef<FundRequestResultsData>[] = [
  ...
  },
  {
    ...
    id: "description",
    accessorFn: (data) =>
      `${data.line_items.map((lineItem: Line_Items) => lineItem.description)}`,
    size: 350,
    footer: "GRAND TOTAL",
  },
  {
    ...
    id: "amount",
    accessorFn: (data) =>
      `₦${data.line_items.map((lineItem: Line_Items) => lineItem.amount)}`,
    size: 300,
        ...
        <div className="space-y-5 p-10">
          ...
          <div className="grid pb-5 grid-cols-2 gap-5 md:grid-cols-3">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-gray-500">{data.month_year}</p>
            </div>
            <div className="space-y-3">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-gray-500">{data.financial_year}</p>
            </div>
          </div>
              ...
              <Table className="border rounded-xl w-full overflow-auto">
                <TableHeader className="bg-gray-200">
                  <TableRow>
                    ...
                    <TableHead className="w-[300px]">Unit Cost</TableHead>
                ...
                <TableBody>
                  {data.line_items.map((item: Line_Items) => (
