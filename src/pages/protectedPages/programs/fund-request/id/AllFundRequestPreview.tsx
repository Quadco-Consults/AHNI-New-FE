...
export default function AllFundRequestPreview() {
    ...
    const availableBalance = fundRequest?.data.results
        .map((fundReq) => fundReq.available_balance)
        .reduce(
            (accumulator, value) =>
                (Number(accumulator as any) + Number(value as any)) as any
        );
                        ...
                        <ShadTable>
                            <TableBody>
                                ...
                                <TableRow>
                                    ...
                                    <TableCell>
                                        {/* @ts-ignore */}$
                                        {totalFundRequest - availableBalance}
                                    </TableCell>
                                </TableRow>
                            </TableBody>
                        </ShadTable>
