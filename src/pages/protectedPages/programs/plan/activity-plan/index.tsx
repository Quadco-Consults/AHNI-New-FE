...
const columns: ColumnDef<TActivityPlanData>[] = [
    {
        header: "Project",
        accessorKey: "project",
        size: 150,
    ...
    },
    {
        ...
        accessorFn: (data) => `${String(data.is_memo_required).toUpperCase()}`,
        size: 150,
    },
    {
        header: "EA Required",
        accessorFn: (data) => `${String(data.is_ea_required).toUpperCase()}`,
        size: 150,
    },
    {
...
const TableAction = ({ data }: { data: TActivityPlanData }) => {
