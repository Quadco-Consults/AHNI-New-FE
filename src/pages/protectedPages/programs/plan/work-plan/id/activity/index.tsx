...
const workPlanDetailsColumn: ColumnDef<TActivity>[] = [
...

  {
    ...
    accessorKey: "_",
    cell: ({ row }) => {
      return row.original.budget_line || "N/A";
    },
...

  {
    ...
    accessorKey: "_",
    cell: ({ row }) => {
      return row.original.objectives_sub_objectives || "N/A";
    },
...

  {
    ...
    cell: ({ row }) => {
      return row.original.description_of_output || "N/A";
    },
    size: 200,
  },
    ...
    columns: [
      {
        ...
        cell: ({ row }) => {
          return row.original.gant_chart?.Oct || "N/A";
        },
        size: 100,
      },

      {
        header: "Nov",
        cell: ({ row }) => {
          return row.original.gant_chart?.Nov || "N/A";
        },
        size: 100,
      },

      {
        header: "Dec",
        cell: ({ row }) => {
          return row.original.gant_chart?.Dec || "N/A";
        },
        size: 100,
      },

      {
        header: "Jan",
        cell: ({ row }) => {
          return row.original.gant_chart?.Jan || "N/A";
        },
        size: 100,
      },

      {
        header: "Feb",
        cell: ({ row }) => {
          return row.original.gant_chart?.Feb || "N/A";
        },
        size: 100,
      },

      {
        header: "Mar",
        cell: ({ row }) => {
          return row.original.gant_chart?.Mar || "N/A";
        },
        size: 100,
      },

      {
        header: "Apr",
        cell: ({ row }) => {
          return row.original.gant_chart?.Apr || "N/A";
        },
        size: 100,
      },

      {
        header: "May",
        cell: ({ row }) => {
          return row.original.gant_chart?.May || "N/A";
        },
        size: 100,
      },

      {
        header: "Jun",
        cell: ({ row }) => {
          return row.original.gant_chart?.Jun || "N/A";
        },
        size: 100,
      },

      {
        header: "Jul",
        cell: ({ row }) => {
          return row.original.gant_chart?.Jul || "N/A";
        },
        size: 100,
      },

      {
        header: "Aug",
        cell: ({ row }) => {
          return row.original.gant_chart?.Aug || "N/A";
        },
        size: 100,
      },

      {
        header: "Sep",
        cell: ({ row }) => {
          return row.original.gant_chart?.Sep || "N/A";
        },
        size: 100,
      },
    ],
  ...
  {
    header: "Total (USD)",
    accessorFn: (data) => formatNumberCurrency(data.total_amount_ngn, "USD"),
    size: 200,
  },
  ...
  },
  {
    ...
    accessorKey: "cost_catergory",
    cell: ({ row }) => {
      return row.original.cost_catergory || "N/A";
    },
    size: 250,
  },
  {
    ...
    cell: ({ row }) => {
      return row.original.intervention_area || "N/A";
    },
    size: 250,
  },
  {
...

  {
    ...
    accessorKey: "_",
    cell: ({ row }) => {
      return row.original.cost_input || "N/A";
    },
    size: 200,
  },

  {
    ...
    cell: ({ row }) => {
      return row.original.cost_grouping || "N/A";
    },
    size: 200,
  },
];
