        ...
        <FormProvider {...form}>
          <form className="space-y-3">
            ...
            {!isUploadPage ? (
              ...
              uploadsCriteria.map((criteria, i) => (
                <Card key={i} className="space-y-3">
                  <h4 className="text-semibold font-light">{criteria}</h4>
                    ...
                    <div className="flex gap-5 justify-between">
                      <div className="flex items-stretch space-x-2">
                        <input
                          ...
                          value="true"
                        />
                        <label htmlFor="yes" className="text-green-500">
                          Yes
                        </label>
                      </div>
                      ...
                      <div className="flex items-stretch space-x-2">
                        ...
                        />
                        <label htmlFor="no" className="text-primary">
                          No
                        </label>
                      </div>
                    </div>
