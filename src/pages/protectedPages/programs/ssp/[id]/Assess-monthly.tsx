  ...
  return (
    <div className="space-y-5">
        ...
        <Form {...form}>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
            ...
            <Card className="space-y-3">
              <h4 className="font-semibold text-red-600">Assess monthly.</h4>
              ...
              <Card className="space-y-3 border-yellow-600">
                ...
                <h6>Triangulate between Source document/DPT/LAMIS</h6>
                ...
                <div className="flex justify-between pb-3 gap-5">
                  <div className="">
                    <h2>Review DQA report for previous quarter</h2>
                  </div>
                  <div className="flex gap-5 justify-between w-1/5">
                    <div className="flex gap-2 items-center text-green-500">
                      <Checkbox className="border-green-500 data-[state=checked]:bg-inherit data-[state=checked]:text-green-500" />
                ...
                <div className="flex justify-between pb-3 gap-5">
                  <div className="">
                    <h2>
                      Availability of CMP register (change management procedure)
                      Review register
                    </h2>
                  </div>
                  <div className="flex gap-5 justify-between w-1/5">
      ...
      <div className="flex justify-between">
        ...
        <Link to={RouteEnum.PROGRAM_SUPPORTIVE_SUPERVISION_TX_NEW}>
