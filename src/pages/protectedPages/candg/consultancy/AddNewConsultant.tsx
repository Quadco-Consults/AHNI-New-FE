...
const AddNewConsultant = () => {
  ...
  const onSubmit: SubmitHandler<typeof ConsultancyApplication> = async (data) => {
    ...
    try {
      const result = await addApplicationMutation({ ...data, job_detail: params.id, referees: refereeArray }).unwrap();
      if (result) {
  ...
  return (
    <div className="flex flex-col text-[#1A0000]">
      <Form {...form}>
        <form className="flex flex-wrap justify-between gap-y-[1.25rem]" action="" onSubmit={form.handleSubmit(onSubmit)}>
          <div className="w-[49%]">
            <FormInput name="applicant_name" label="Name" required />
          </div>
          <div className="w-[49%]">
            <FormInput name="applicant_email" label="Email" required />
          </div>
          <div className="w-[49%]">
            <FormInput name="applicant_phone_number" label="Phone Number" required />
          </div>
          <div className="w-[49%]">
            <FormInput name="employment_type" label="Employment Type" required />
          </div>
