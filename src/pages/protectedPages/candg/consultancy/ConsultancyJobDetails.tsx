...
const ConsultancyJobDetails = () => {
    ...
    const consultancyDetails = consultancyAPIs.useGetSingleConsultancyQuery(
        params.id
    );
            ...
            <Card className="w-full flex flex-col gap-y-[1rem]">
                ...
                <div className="w-[50%] flex flex-wrap items-center justify-start gap-x-[.625rem] gap-y-[.5rem]">
                    {/* <DetailsTag
                        ...
                        deet={`(${
                            PageData?.number_of_consultants || ""
                        } positions)`}
                    />
                    <DetailsTag
                        icon={<ClockTimingSvg />}
                    ...
                    <DetailsTag
                        ...
                        deet={formatDate(
                            new Date(
                                PageData?.effective_end_date || new Date()
                            ),
                    ...
                    <DetailsTag
                        icon={<LocationSvg />}
                        deet={
                            PageData?.locations?.map((loc: any) => `${loc} `) ||
                            []
                        }
                    />
                ...
                <div className="w-fit">
                    <Card className="w-[18.5rem] overflow-hidden h-[19.75rem] justify-center gap-y-[1rem] flex flex-col">
                        <div className="flex items-center gap-x-[.75rem]">
                            <PDFICon />
                            <p className="font-semibold text-[#756D6D]">
                                Full Advert Document
                            </p>
                        </div>
