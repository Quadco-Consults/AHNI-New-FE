...
const SubGrantSubmissionDetails = () => {
    ...
    const getSubGrantsApplications =
        SubGrantApplicationsApi.useGetSubGrantsApplicationQuery({
    ...
    const ActionListAction = ({ data }: any) => {
        const [subgrantDeleteMutation] =
            SubGrantApplicationsApi.useDeleteSingleSubGrantsApplicationMutation();
