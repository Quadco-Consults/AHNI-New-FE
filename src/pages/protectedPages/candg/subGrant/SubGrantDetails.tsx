...
const SubGrantDetails = () => {
  ...
  const tabDetails = [
    { id: 1, state: "details", name: "details", tabComponent: <SubGrantAwardDetails /> },
    { id: 2, state: "submissions", name: "Submissions", tabComponent: <SubGrantSubmissionDetails /> },
    { id: 2, state: "awarded-beneficiaries", name: "Awarded Beneficiaries", tabComponent: <></> },
  ];
