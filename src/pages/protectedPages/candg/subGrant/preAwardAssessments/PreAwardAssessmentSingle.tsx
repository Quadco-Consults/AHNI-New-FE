...
const PreAwardAssessmentSingle = () => {
  ...
  const tabDetails = [
    ...
    { id: 2, state: "pre-award-assessment-result", name: "Pre-award Assessment Result", tabComponent: <PreAwardAssessmentResult /> },
  ];
    ...
    <main className="w-full flex flex-col items-center justify-center gap-y-[1.875rem]">
      <section className="w-full flex items-center justify-between">
        ...
        <div>
          <Link
            className="w-full"
            to={generatePath(CandGRoutes.PRE_AWARD_ASSESSMENT_STEP_1, {
              id: params?.id,
            })}
          >
