...
const AddPrequalificationCategory = () => {
  ...
  const [prequalificationCategory, { isLoading }] =
    useAddPrequalificationCategoryMutation();
  const [updatePrequalificationCategory, { isLoading: updatePrequalificationCategoryLoading }] =
    useUpdatePrequalificationCategoryMutation();
      ...
      <Form {...form}>
        ...
        >
          ...
          <div className="flex justify-start gap-4">
            <FormButton loading={isLoading || updatePrequalificationCategoryLoading}>
              Save
            </FormButton>
          </div>
        </form>
