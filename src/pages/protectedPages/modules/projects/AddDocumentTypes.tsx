...
import { useAddDocumentTypesMutation, useUpdateDocumentTypesMutation } from "services/moduleProjects";
...
const AddDocumentTypes = () => {
  ...
  const [updateDocumentTypes, { isLoading: updateDocumentLoading }] = useUpdateDocumentTypesMutation();
        ...
        <Form {...form}>
          ...
          >
            ...
            <div className="flex justify-start gap-4">
              <FormButton loading={isLoading || updateDocumentLoading}>Save</FormButton>
            </div>
          </form>
        </Form>
      </CardContent>
