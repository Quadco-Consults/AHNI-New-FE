...
import { useSupervisionCategoryQuery, useDeleteSupervisionCategoryMutation } from "services/module-programs";
...
const SupervisionCategory = () => {
  ...
  const [deleteSupervisionCategory] = useDeleteSupervisionCategoryMutation();
