...
const Upload = () => {
  ...
  const vendorDocumentsQueryResult =
    VendorsDocumentAPI.useGetVendorDocumentsQuery({
      params: { vendor: localStorage.getItem("vendorID") as string },
    });

  const vendorDocuments = vendorDocumentsQueryResult?.data?.results;

  const [createVendorDocumentMutation, { isLoading }] =
  ...
  const handleUploadHandler = async () => {
    ...
    formData.append("vendor", localStorage.getItem("vendorID") as string);
                  ...
                  {vendorDocuments?.map((doc: VendorsDocumentResultsData) => (
                    ...
                    >
                      ...
                      {doc.document.endsWith("pdf") ? (
                        ...
                        <div className="h-56">
                          <img src={doc.document} alt={doc.document_type} />
                        </div>
                      )}
                  ...
                  <Dialog>
                    ...
                    <DialogContent className=" max-w-lg p-10">
                      ...
                      <div className="flex flex-col gap-6">
                        <Select onValueChange={handleDocType}>
                          <SelectTrigger>
