...
const ProcurementMilestones = (props: Props) => {
  ...
  const milestones = [
    ...
    { step: 2, date: "13-jul-2024", description: "Advertise Bid (national dailies, short-listed vendors, website etc.)" },
  ...
  return (
    <div className='w-[95%] mx-auto space-y-4 pt-4'>
        <h3 className='text-primary text-xl font-semibold py-12'>Procurement Milestones</h3>

        <div className="grid justify-between w-full grid-row-6 px-4 py-2 gap-y-4">
        {milestones.map((milestone, index) => (
          <div className="flex flex-col items-start justify-center relative" key={index}>
            ...
            <div className="mx-4">
              ...
              <span>{index < currentStep  ? <CheckIcon /> : <PendingIcon />}</span>
              <div className="space-y-1">
                <div className="text-[10px] font-semibold text-gray-400 capitalize">{milestone.date}</div>
       ...
       <span className="w-full flex items-center justify-end gap-5">
          <Button type="button" className="bg-[#FFF2F2] text-primary " onClick={() => {}}>
           Cancel
          </Button>
