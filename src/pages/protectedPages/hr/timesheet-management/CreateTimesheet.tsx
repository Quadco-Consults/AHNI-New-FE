...
const CreateTimesheet = () => {
  ...
  >([]);
  console.log(matchedStakeholdersData);

  const stakeholderQueryResult = StakeholderAPI.useGetStakeholdersQuery({});
  const employees = stakeholderQueryResult?.data?.results;
          ...
          <form className="space-y-10">
            ...
            <div className="space-y-4">
              ...
              <div className="gap-4 grid grid-cols-1 md:grid-cols-3">
                {matchedStakeholdersData.map((employee, index) => (
                  <div
                    key={index}
                      ...
                      <div className="flex justify-end">
                        <div className="flex items-center gap-4">
                          <h6 className="text-primary">
                            {watch("submitted_employees")?.length} categories
                            Selected
                          </h6>
                          <DialogClose>
