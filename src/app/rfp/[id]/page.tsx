...
export default function RFPDetailsPage() {
        ...
        <Card>
          <div className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              The Request for Proposal you're looking for could not be found or may have expired.
            </p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 pb-12">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mt-6">
            ...
            {opportunity.rfp_number && (
              <p className="text-muted-foreground">RFP Number: {opportunity.rfp_number}</p>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <Card className="mb-6 border-2 border-purple-500/50 bg-gradient-to-r from-purple-50 to-white">
          <div className="p-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground mb-4">
                  To submit a proposal for this RFP, you must be a prequalified vendor with an active vendor portal account.
                </p>
        ...
        <Card className="mb-6">
          <div className="p-6">
            <h2 className="text-xl font-semibold text-foreground mb-4">RFP Overview</h2>
        ...
        <Card>
          <div className="p-6">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <a href="mailto:procurement@ahnigeria.org" className="text-purple-600 hover:underline">
            ...
            <Alert className="mt-4">
              ...
              <AlertDescription>
                Proposals can only be submitted through the vendor portal by prequalified vendors.
              </AlertDescription>
            </Alert>
          </div>
        </Card>
